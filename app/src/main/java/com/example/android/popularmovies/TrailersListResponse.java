...
public class TrailersListResponse implements Serializable{
    private int page;
    private Trailer[] results;
    private int total_pages;
    private int total_results;

    public TrailersListResponse(){
    ...
    public Trailer[] getResults(){return results;}

    public void setResults(Trailer[] results){this.results = results;}
